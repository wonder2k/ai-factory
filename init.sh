...
# ==============================================================================
# 🚀 Hermes AI Factory - 终极无瑕完全体脚手架 (DeepSeek 代理 + 10大插件 + Karpathy原则)
# ==============================================================================
...
echo "===================================================="
echo "🌱 开始从零释放【合体进化版】AI Factory 全套核心配置文件..."
...
# 3. 写入 docker/Dockerfile.claude (合体进化：集成 fcc 软链接与构建期环境)
...
# 4. 写入 docker-compose.yml (★ 极致精简：完全砍掉中间商容器，回归纯净三剑客)
...
# 5. 写入 hermes-server.js (★ 史诗优化：原生就地执行 fcc-claude，再也不跨容器套娃)
...
# 6. 写入 CLAUDE.md (★ 彻底告别 cat 闭合标记，改用极致安全的 echo 追加模式)
...
echo "===================================================="
echo "🎉 恭喜！完美的究极合体版脚手架资产已全部无缝吐出在当前目录下！"
