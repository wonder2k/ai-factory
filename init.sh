...
# ==============================================================================
# 🚀 Hermes AI Factory - 终极无瑕完全体 (基于官方实证 Ground Truth 校准版)
# ==============================================================================
...
echo "===================================================="
echo "🌱 开始从零释放【官方实证校准版】AI Factory 全套核心配置文件..."
...
# 3. 写入 docker/Dockerfile.claude (注入实证发现的完全体基因)
...
# D. 🌟 动态点火：容器启动时完成 fcc 密钥注入、后台代理拉起、10大官方插件静默收割与实证配置固化
CMD ["sh", "-c", "\
...
sleep 3 && \
echo '🔌 4. 正在通过 DeepSeek 渠道强行收割 10 大官方高级插件并同步元数据...' && \
...
echo '⚙️  5. 🌟 注入官方实证 Ground Truth 核心配置文件...' && \
mkdir -p ~/.claude && \
echo '{\"mcpServers\":{},\"enabledPlugins\":[\"claude-code-setup\",\"claude-md-management\",\"code-review\",\"code-simplifier\",\"context7\",\"feature-dev\",\"frontend-design\",\"playwright\",\"superpowers\",\"security-guidance\"],\"theme\":\"dark\"}' > ~/.claude/settings.json && \
...
console.log("🚀 Hermes 总控大脑【究极完美版】已点火，正在丝滑监听 Telegram 消息...");
pollUpdates();
EOF
...
echo "===================================================="
echo "🎉 恭喜！完美融合官方 Ground Truth 的究极版脚手架已大功告成！"
